 ...
 */
export function planAgents(cwd: string, skillFiles: SkillFile[], skillsDir: string, ctx: TemplateContext, meta: PlanMeta): PlannedFile[] {
  return planSkillsDir(join(cwd, ...AGENTS_SKILLS_ROOT), skillFiles, skillsDir, ctx, meta)
}
